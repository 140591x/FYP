...
//        pad_size <= 9'd0;
    ...
    assign pad_size =  (MIN_FRAME_SIZE > (LEN_TYPE*8 + 2*ADDRESS_SIZE + 48))?(MIN_FRAME_SIZE - (LEN_TYPE*8 + 2*ADDRESS_SIZE + 48))/8:0;
...
//            pad_size <= 9'd0;
        ...
        begin
            ...
            begin
                ...
                if(byte_count[15:3] == pad_end_size[15:3])
                begin
                    pad_remove <= 0;
                end
            end
